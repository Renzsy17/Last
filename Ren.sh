...
echo
echo
echo -e "                       V̳E̳R̳S̳I̳ T̳E̳R̳B̳A̳R̳U̳ T̳O̳O̳L̳S̳R̳E̳N̳"
echo -e "                            By: REN☕"
...
clear
sleep 1
xdg-open "https://youtube.com/@RendiWangsaff"
echo -e " MAKASIH YANG UDAH FOLLOW AKUN SUBSCRIBE AKU☺☺☺"
echo -e " MAKASIH YANG UDAH FOLLOW AKUN SUBSCRIBE AKU☺☺☺"
echo -e " MAKASIH YANG UDAH FOLLOW AKUN SUBSCRIBE AKU☺☺☺"
fi
if [ $ren9999 == bug ]
...
clear
sleep 1
xdg-open "https://wa.me/6285716245371?text=Bang ada bug di ToolsRenv2"
fi
if [ $ren9999 == 0 ]
then
clear
